# Set Up the Natural Language to AQL Service

Deploy and configure the Natural Language to AQL service on the Arango Contextual Data Platform, including LLM provider configuration and Secrets Manager integration
...
[Secrets Manager](https://docs.arango.ai/platform-suite/secrets-manager/)
...
[ArangoDB Authentication](https://docs.arango.ai/arangodb/stable/develop/http-api/authentication/#jwt-user-tokens)
documentation.
...
| `chat_api_key` **or**`chat_secret_profile_id` | LLM provider API key, or the name of a secret stored in the [Secrets Manager](https://docs.arango.ai/platform-suite/secrets-manager/) |
...
The [deployment example](https://docs.arango.ai/agentic-ai-suite/natural-language-to-aql/setup/#start-the-service) above uses OpenAI directly. Provide
...
in the [Secrets Manager](https://docs.arango.ai/platform-suite/secrets-manager/):
...
Once the service is running, see the [API Reference](https://docs.arango.ai/agentic-ai-suite/natural-language-to-aql/api-reference/) for endpoint
documentation.

On this page

×![](https://docs.arango.ai/agentic-ai-suite/natural-language-to-aql/setup/)

Ask AI

![AI chat avatar](https://docs.arango.ai/favicon.svg)