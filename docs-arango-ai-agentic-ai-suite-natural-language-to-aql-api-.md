...
service. For deployment and configuration, see [Setup](https://docs.arango.ai/agentic-ai-suite/natural-language-to-aql/setup/).
...
https://<EXTERNAL\_ENDPOINT>:8529/graph-rag/:serviceIdPostfix/v1/...
...
POSThttps://<EXTERNAL\_ENDPOINT>:8529/graph-rag/:serviceIdPostfix/v1/process\_text
...
POSThttps://<EXTERNAL\_ENDPOINT>:8529/graph-rag/:serviceIdPostfix/v1/process\_text\_stream
...
POSThttps://<EXTERNAL\_ENDPOINT>:8529/graph-rag/:serviceIdPostfix/v1/translate\_query
...
GEThttps://<EXTERNAL\_ENDPOINT>:8529/graph-rag/:serviceIdPostfix/v1/health
...
×![](https://docs.arango.ai/agentic-ai-suite/natural-language-to-aql/api-reference/)
